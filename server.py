...
class HTTPStatusError(Exception):
    ...
    def __init__(self, status, description=None) -> None:
        """
...
class ChunkedHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def query_get(self, queryData, key, default="")-> Any:
    ...
    def route_voices(self, path, query) -> ResponseData:
    ...
    def route_read(self, path, query) -> ResponseData:
    ...
    def send_headers(self, status, content_type) -> None:
    ...
    def stream_data(self, stream) -> None:
